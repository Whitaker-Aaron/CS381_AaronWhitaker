...
namespace cs381 {
	...
	SkyBox& SkyBox::Init() {
		...
		shader = raylib::Shader::Load("../generated/skybox.330.vs", "../generated/skybox.330.fs");
	...
	SkyBox& SkyBox::Load(const std::string_view filename, bool isEnviornment/* = false*/) {
		...
		if(isEnviornment) {
			if(cubemapShader.id == 0){
				cubemapShader = raylib::Shader::Load("../generated/cubemap.330.vs", "../generated/cubemap.330.fs");
